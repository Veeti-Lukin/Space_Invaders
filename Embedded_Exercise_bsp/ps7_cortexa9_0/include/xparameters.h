...
/* Definitions for peripheral PIXEL_CTRL */
#define XPAR_PIXEL_CTRL_BASEADDR 0x41220000
#define XPAR_PIXEL_CTRL_HIGHADDR 0x4122FFFF
#define XPAR_PIXEL_CTRL_DEVICE_ID 0
#define XPAR_PIXEL_CTRL_INTERRUPT_PRESENT 0
#define XPAR_PIXEL_CTRL_IS_DUAL 1
...
/* Canonical definitions for peripheral PIXEL_CTRL */
#define XPAR_GPIO_0_BASEADDR 0x41220000
#define XPAR_GPIO_0_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_PIXEL_CTRL_DEVICE_ID
